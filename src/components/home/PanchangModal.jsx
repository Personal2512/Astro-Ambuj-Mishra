          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-4 bg-cream rounded-lg overflow-hidden border border-[#2a3672]">
              {tabs.map((tab) => (
                <button
                  ...
                  className={`py-4 capitalize font-medium ${activeTab === tab
                      ? "border-b-2 border-gold text-midnight hover:colour-gold" : "text-midnight"
                    }`}
                >
                  {tab}
                </button>
            ...
            {activeTab === "muhurat" && (
              <div className="mt-6 bg-cream rounded-xl p-6 border border-[#26336e]">
                <h2 className="text-midnight text-3xl font-bold mb-4">
                  Abhijit Muhurat
                </h2>
